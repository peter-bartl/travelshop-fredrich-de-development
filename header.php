            ...
            <div class="row header-main-row">
                ...
                <div class="col-auto align-self-center ">
                    <a class="navbar-brand" href="<?php echo site_url(); ?>">
                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/travelshop-logo.svg" height="24" width="142" class="d-inline-block align-middle" alt="<?php echo get_bloginfo('name'); ?>">
                        test
                    </a>
                </div>
                ...
                <div class="col-auto align-self-center  d-none d-lg-block col-search" id="search">
                    <form class="form-string-search input-group my-2 my-lg-0" action="<?php echo site_url() . '/' . Pressmind\Travelshop\RouteHelper::get_url_by_object_type(TS_TOUR_PRODUCTS) . '/'; ?>" method="GET">
                        <input class="form-control auto-complete" type="search" data-autocomplete="true" placeholder="Suchbegriff..." aria-label="Search" name="pm-t">
